...
def run() -> None:
    ...
    print('Enter path to file containing Alpha Vantage API key:')
    key_path = input()
    f = open(key_path, "r")
    api_key = f.read()
    URL = input()
    print('Enter symbol associated with the stock, such as AAPL or MSFT:')
    symbol = input()
    print('Enter Start date:')
    start_date = input()
    print('Enter End date:')
    end_date = input()
    print('Enter combination of indicator and signal strategy:')
    indicator = input()
